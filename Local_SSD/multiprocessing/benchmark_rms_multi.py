...
for n in range(24):
    ...
    np.save('/oasis/scratch/comet/sfan19/temp_project/SSD/multiprocessing/900_Frames/RMS/data4/universe_rms_multi', t_u)
    np.save('/oasis/scratch/comet/sfan19/temp_project/SSD/multiprocessing/900_Frames/RMS/data4/wait_rms_multi', t_w)
    np.savetxt('/oasis/scratch/comet/sfan19/temp_project/SSD/multiprocessing/900_Frames/RMS/data4/benchmark_rms_multi.dat', np.array(t_time))
    np.savetxt('/oasis/scratch/comet/sfan19/temp_project/SSD/multiprocessing/900_Frames/RMS/data4/io_rms_multi.dat', np.array(t_io))
    np.savetxt('/oasis/scratch/comet/sfan19/temp_project/SSD/multiprocessing/900_Frames/RMS/data4/compute_rms_multi.dat', np.array(t_compute))
